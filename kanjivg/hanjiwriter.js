...
var HanziWriter = (function () {
  ...
  const requestAnimationFrame =
    ((_globalObj$requestAni = globalObj.requestAnimationFrame) === null ||
    _globalObj$requestAni === void 0
      ? void 0
      : _globalObj$requestAni.bind(globalObj)) ||
    ((callback) => setTimeout(() => callback(performanceNow()), 1000 / 60));
  const cancelAnimationFrame =
    ((_globalObj$cancelAnim = globalObj.cancelAnimationFrame) === null ||
    _globalObj$cancelAnim === void 0
      ? void 0
      : _globalObj$cancelAnim.bind(globalObj)) || clearTimeout; // Object.assign polyfill, because IE :/
  ...
  const isMsBrowser =
    ...
    ua.indexOf("Edge/") > 0; // eslint-disable-next-line @typescript-eslint/no-empty-function
  ...
  const getMatchData = (points, stroke, options) => {
    ...
    const withinDistThresh =
      avgDist <= averageDistanceThreshold * distMod * leniency; // short circuit for faster matching
  ...
  const removeAllUserStrokes = (userStrokeIds) => {
    return (
      (userStrokeIds === null || userStrokeIds === void 0
        ? void 0
        : userStrokeIds.map(
            (userStrokeId) =>
  ...
  class Quiz {
    ...
    startUserStroke(externalPoint) {
      ...
      (_this$_userStrokesIds = this._userStrokesIds) === null ||
      _this$_userStrokesIds === void 0
        ? void 0
        : _this$_userStrokesIds.push(strokeId);
    ...
    endUserStroke() {
      ...
      const { acceptBackwardsStrokes, markStrokeCorrectAfterMisses } =
        this._options;
      ...
      const isAccepted =
        isMatch ||
        isForceAccepted ||
        (meta.isStrokeBackwards && acceptBackwardsStrokes);
